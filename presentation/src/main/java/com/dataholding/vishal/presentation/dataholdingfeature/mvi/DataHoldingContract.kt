...
interface DataHoldingContract: MVIContract<DataHoldingContract.DataHoldingState, DataHoldingContract.DataHoldingEffect, DataHoldingContract.DataHoldingEvent>{
    ...
    sealed class DataHoldingEffect {
        data class NavigateToDataHoldingDetailsDetails(val dataHoldingData: HoldingData?): DataHoldingEffect()
    }
}
